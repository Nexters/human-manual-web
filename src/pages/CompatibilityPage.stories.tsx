...
const MINE_CODE = "STORYMIN";
const FRIEND_CODE = "STORYFRI";

const mockCompatibility: CompatibilityOutput = {
  mine: {
    nickname: "지은",
    noun: "팽이",
...
function createStoryQueryClient() {
  ...
  client.setQueryData(compatibilityQueryKey(MINE_CODE, FRIEND_CODE), mockCompatibility);
  return client;
}
  ...
  decorators: [
    (Story) => (
      <QueryClientProvider client={createStoryQueryClient()}>
        <MemoryRouter initialEntries={[`/compatibility?mine=${MINE_CODE}&friend=${FRIEND_CODE}`]}>
          <Routes>
